 ...
 *    (60)    (120)             3. node120    +1        *
 *   /  \     /   \             4. node50      0        *
 * (50)(70) (100)(160)          5. node70      0        *
 *          /     / \           6. node100    -1        *
 *        (90) (140)(170)       7. node160    -1        *
 *             /  \             8. node90      0        *
 *          (130)(150)          9. node140     0        *
 *                             10. node170     0        *
 *                             11. node130     0        *
 ...
 *       (80)       (160)         4. node50      0      *
 *      /   \       /   \         5. node70      0      *
 *   (60)   (100)(140) (170)      6. node100    -1      *
 *   / \    /    /   \            7. node160    -1      *
 *(50)(70)(90) (130)(150)         8. node90      0      *
 *                                9. node140     0      *
 *                               10. node170     0      *
 *                               11. node130     0      *
 *                               12. node150     0      *
 ********************************************************/
void test_leftRotate_given_treeA_with_case_neg1_1_neg1_should_rotate_to_treeB_with_appropriate_BF(void){
  ...
  i = avlAdd(&testTree, &node90);
  i = avlAdd(&testTree, &node140);
  i = avlAdd(&testTree, &node170);
  i = avlAdd(&testTree, &node130);
  i = avlAdd(&testTree, &node150);
  ...
  TEST_ASSERT_EQUAL_NODE( 70,  0, &node70);
  TEST_ASSERT_EQUAL_NODE(100, -1, &node100);
  TEST_ASSERT_EQUAL_NODE(160, -1, &node160);
  TEST_ASSERT_EQUAL_NODE( 90,  0, &node90);
  TEST_ASSERT_EQUAL_NODE(140,  0, &node140);
  TEST_ASSERT_EQUAL_NODE(170,  0, &node170);
  TEST_ASSERT_EQUAL_NODE(130,  0, &node130);
  TEST_ASSERT_EQUAL_NODE(150,  0, &node150);
}
